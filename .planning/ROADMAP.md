...
- [ ] **Phase 4: CPU-Safe Characterization Tests** - Users can rely on lightweight fixtures and deterministic tests for fragile config, data, reward, prompt, and objective behavior. *(2/6 plans complete)*
...
| 4. CPU-Safe Characterization Tests | 2/6 | In progress | 04-01, 04-02 |
