...
- [ ] **Phase 6: Reward and Evaluation Validity** - Users can produce comparable held-out evaluations, reward diagnostics, and thesis-ready outputs from recorded runs. *(1/7 plans complete)*
...
| 6. Reward and Evaluation Validity | 1/7 | In progress | 06-01 |
