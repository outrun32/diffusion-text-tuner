...
_EXTENSION_POINTS: tuple[ExtensionPoint, ...] = (
    ExtensionPoint(
        ...
        purpose=(
            "Create multilingual/Cyrillic text-rendering prompt JSONL datasets "
        ...
        generated_artifact_notes=(
            "Prompt JSONL outputs are generated data; keep full datasets under ignored "
            "data/runs roots unless intentionally tiny fixtures."
        ),
    ),
    ExtensionPoint(
        name="image generation",
        purpose=(
            "Generate FLUX images, latents, and text embeddings through an importable "
            "orchestration seam."
        ),
        ...
        generated_artifact_notes=(
            "Generated images, latents, embeddings, metadata, and manifests stay in "
            "ignored outputs/ or runs/ roots."
        ),
    ),
    ExtensionPoint(
        name="scoring",
        purpose=(
            "Score generated images and write canonical reward rows, sidecars, and "
            "scorer provenance."
        ),
        ...
        generated_artifact_notes=(
            "Score CSV/JSONL files and sidecars may contain prompt text, local paths, "
            "and reward evidence; keep runtime score outputs ignored by default."
        ),
    ),
    ExtensionPoint(
        name="synthesis",
        purpose=(
            "Build synthetic masked-SFT datasets through reusable render, collation, "
            "latent, and text-encoding phases."
        ),
        ...
        generated_artifact_notes=(
            "Synthetic images, masks, latents, embeddings, indexes, and quality reports "
            "remain generated artifacts under ignored data/ or runs/ roots."
        ),
    ),
    ExtensionPoint(
        name="training",
        purpose=(
            "Extend SFT, DPO, masked-SFT, runtime metadata, objective helpers, "
            "sampling, schedulers, and checkpointing without hiding trainer choices."
        ),
        ...
        generated_artifact_notes=(
            "Checkpoints, logs, sample images, tensors, and run manifests are runtime "
            "artifacts; record provenance but do not commit generated outputs."
        ),
    ),
    ExtensionPoint(
        name="evaluation",
        purpose=(
            "Materialize held-out evaluation plans and validate recorded "
            "reward/evaluation evidence without launching expensive work by default."
        ),
        ...
        generated_artifact_notes=(
            "Held-out plans, generated eval outputs, scores, and manifests belong "
            "under ignored runs/ or outputs/ roots."
        ),
    ),
    ExtensionPoint(
        name="plotting",
        purpose=(
            "Load, summarize, smooth, and plot training metrics through import-safe "
            "helpers with lazy plotting backends."
        ),
        ...
        generated_artifact_notes=(
            "Training curves and thesis plots are generated artifacts; keep figures "
            "under ignored run/output roots unless reviewed as tiny docs assets."
        ),
    ),
    ExtensionPoint(
        name="run comparison",
        purpose=(
            "Compare local run manifests and controlled training settings before "
            "interpreting experiments as thesis evidence."
        ),
        ...
        generated_artifact_notes=(
            "Comparison Markdown/JSON reports should be written under ignored "
            "runs/comparisons/ unless intentionally tiny reviewed evidence."
        ),
    ),
    ExtensionPoint(
        name="diagnostics",
        purpose=(
            "Inspect reward disagreements, gold slices, gradients, and manual checks "
            "through explicit opt-in diagnostics outside default heavy jobs."
        ),
        ...
        generated_artifact_notes=(
            "Diagnostic reports, contact sheets, local paths, prompt text, scores, "
            "and logs are runtime/private artifacts by default."
        ),
    ),
    ExtensionPoint(
        name="thesis outputs",
        purpose=(
            "Build thesis-ready tables, SVG plots, contact sheets, bundles, and "
            "Markdown summaries from recorded manifests and reports."
        ),
